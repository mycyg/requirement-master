const STATUS_ZH: Record<string, { label: string; cls: string }> = {
  ...
  summary_ready:      { label: "待确认投递", cls: "border-[#e0c895] bg-[#fff6dc] text-[#8a5d10]" },
  ...
  delivery_doc_pending: { label: "交付文档生成中", cls: "border-[#b9c8d7] bg-[#edf3f7] text-[#405f78] animate-pulse" },
